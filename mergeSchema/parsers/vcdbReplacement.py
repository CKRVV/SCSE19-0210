#Dictionaries only allow tuples as keys
...
tuple(["Security Services"]) : ["National Security","Correctional Institutions","Security Systems Services (except Locksmiths)","Security Guards and Patrol Services","Investigation Services","Investigation and Security Services"],
...
tuple(["Wholesaler"]) : ["Wholesalers","Wholesale Trade","Nursery, Garden Center, and Farm Supply Stores","All Other Health and Personal Care Stores","Meat Processed from Carcasses","Fruit and Vegetable Canning","Food Service Contractors","Florists"],
...
tuple(["Oil and Gas"]) : ["Oil and Gas Extraction","Gasoline Stations with Convenience Stores","Fossil Fuel Electric Power Generation","Drilling Oil and Gas Wells","Gasoline Stations","Other Gasoline Stations","Petroleum Refineries","Natural Gas Distribution","Support Activities for Oil and Gas Operations"],
...
tuple(["Publisher"]) : ["Publishers","News Syndicates","Document Preparation Services"],
tuple(["Tourism"]) : ["Travel Agencies","Casinos (except Casino Hotels)","Casino Hotels", "Hotels (except Casino Hotels) and Motels",
"Amusement and Theme Parks","Other Traveler Accommodation","Amusement, Gambling, and Recreation Industries","All Other Travel Arrangement and Reservation Services","All Other Amusement and Recreation Industries","Tour Operators","Recreational and Vacation Camps (except Campgrounds)","Museums","Traveler Accommodation"],
...
tuple(["Metal Industry"]) : ["Iron and Steel Forging","Steel Foundries (except Investment)"],
...
tuple(["Delivery Services"]) : ["Specialized Freight (except Used Goods) Trucking, Long-Distance","Couriers and Express Delivery Services","Packaging and Labeling Services","Couriers and Messengers","Marine Cargo Handling"],
tuple(["Other Services"]) : ["Translation and Interpretation Services","Other Personal Care Services","Exterminating and Pest Control Services","Miscellaneous Intermediation","Facilities Support Services","Coin-Operated Laundries and Drycleaners","Beauty Salons","Funeral Homes and Funeral Services","Other Similar Organizations (except Business, Professional, Labor, and Political Organizations)","Other Services (except Public Administration)","Offices of Other Holding Companies"],
tuple(["Printing Services"]) : ["Commercial Printing (except Screen and Books)","Printing"],
tuple(["Agriculture"]) : ["Agriculture","Agricultural","Grape Vineyards"],
